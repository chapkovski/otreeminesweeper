...
class Player(BasePlayer):
    ...
    notes = models.IntegerField(min=0, max=10000, label='How many separate notes (approximate) did you take throughout the experiment (put a 0 if none)?')
...
class MyPage(PageInherit):
    ...
    form_fields = ['gender', 'age', 'education', 'work','minesweeper', 'minesweeper2','videogames',
                   'budgetpressure','deviation','notes' ]
