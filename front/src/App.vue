        ...
        <v-app>
            ...
            <v-app-bar app>
                <div v-if="limitExhausted()">
                    <v-alert type="danger" color="red">You exhausted number of allowed clicks</v-alert>
                </div>
            ...
            <v-main>
                <div class="form-data" v-show="false">
                    ...
                    <div v-for="(grid, ind) in grids" :key="ind">
                        <input type="hidden" :name="`total_penalty_${ind + 1}`" :value="total_penalty(ind)" />
                        <input type="hidden" :name="`used_clicks_${ind + 1}`" :value="grid.used_clicks" />
                        <input type="hidden" :name="`clicks100_${ind + 1}`" :value="grid.clicksTo100" />
                        <input type="hidden" :name="`clicks80_${ind + 1}`" :value="grid.clicksTo80" />
                    </div>
                </div>
                <v-container>
                    <v-row>
