...
class Player(BasePlayer):
    ...
    q3 = models.IntegerField(choices=[[1, 'Whether you stay below the recommended budgeted clicks for each grid (i.e., your click efficiency)'],
    ...
    q5 = models.IntegerField(choices=[[1, 'Count the number of clicks you have used or bombs you have found for the period'],
